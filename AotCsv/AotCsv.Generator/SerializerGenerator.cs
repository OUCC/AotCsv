...
public class SerializerGenerator : IIncrementalGenerator
{
    ...
    private static void Emit(SourceProductionContext context, GeneratorAttributeSyntaxContext source, Compilation compilation)
    {
        ...
        var containingTypes = GetTargetMembersContainingTypes(targetSymbol, reference);
    ...
    private static List<ITypeSymbol> GetTargetMembersContainingTypes(INamedTypeSymbol targetSymbol, ReferenceSymbols reference)
    {
