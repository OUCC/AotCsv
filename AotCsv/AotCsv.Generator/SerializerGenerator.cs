...
public class SerializerGenerator : IIncrementalGenerator
{
    ...
    private static void Emit(SourceProductionContext context, GeneratorAttributeSyntaxContext source, Compilation compilation)
    {
        ...
        var containingTypes = GetTargetSymbolContainingTypes(targetSymbol);
        ...
        foreach (var containingType in containingTypes)
        {
            builder.AppendFormatted($$"""
                ...
                partial {{(containingType.IsRecord ? "record " : "")}}{{(containingType.TypeKind == TypeKind.Class ? "class" : "struct")}} {{containingType.Name}} {
                """);
        }
        ...
        WriteMetadata(builder, targetTypeName, targets);
    ...
    private static List<ITypeSymbol> GetTargetSymbolContainingTypes(INamedTypeSymbol targetSymbol)
    {
